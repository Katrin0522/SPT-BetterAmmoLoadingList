...
public class OverlayDebug: MonoBehaviour
{
    ...
    public void Enable()
    {
        ...
        _overlay = new GameObject("[DynamicClearBots] Overlay", typeof(Canvas), typeof(CanvasScaler), typeof(GraphicRaycaster));
        ...
        var textObj = new GameObject("[DynamicClearBots] OverlayText", typeof(RectTransform));
